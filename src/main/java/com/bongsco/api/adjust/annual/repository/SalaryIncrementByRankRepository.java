...
public interface SalaryIncrementByRankRepository extends JpaRepository<SalaryIncrementByRank, Long> {
    ...
    @Query("DELETE FROM SalaryIncrementByRank s WHERE s.adjustGrade IN :adjustGrades")
    void deleteByAdjustGrades(@Param("adjustGrades") List<AdjustGrade> adjustGrades);
}
